module.exports = {
  ...
  blogAuthorId: "Kaz", // The default and fallback author ID used for blog posts without a defined author.
  siteTitle: "Certification Study Blog", // Site title.
  siteTitleAlt: "Certification Study", // Alternative site title for SEO.
  siteLogo:
  ...
  siteDescription:
    "Ani Chat's Blog for weekly Cert study.", // Website description used for RSS feeds/meta description tag.
  siteCover:
  ...
  siteRssAuthor: "Kaz", // The author name used in the RSS file
  ...
  copyright: {
    label: "Weekly Cert Study" // Label used before the year
